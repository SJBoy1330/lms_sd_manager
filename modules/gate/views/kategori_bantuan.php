    ...
    <div class="card mb-5 mb-xl-8">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1">Kategori Bantuan</span>
                ...
                <table class="table align-middle gs-0 gy-4">
                    ...
                    <thead>
                        <tr class="fw-bolder text-muted bg-light">
                            ...
                            <th class="min-w-200 text-center">Judul</th>
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <!--begin::Modal title-->
                <h2 class="fw-bolder">Tambah Kategori Bantuan</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-8 mb-7">
                ...
                <form id="kt_modal_export_users_form" class="form" action="#">
                    <div class="fv-row mb-10">
                        <!--begin::Label-->
                        <label class="required fs-6 fw-bold form-label mb-2">Nama Kategori</label>
                        <!--end::Label-->
                        <div class="position-relative d-flex align-items-center">
                            <input class="form-control form-control-solid"  placeholder="Masukkan nama kategori" />
                        </div>
                    </div>
                    <!--begin::Input group-->
                    <div class="fv-row mb-10">
