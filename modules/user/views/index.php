                ...
                <table class="table align-middle gs-0 gy-4">
                    ...
                    <thead>
                        <tr class="fw-bolder text-muted bg-light">
                            ...
                            <th class="min-w-200 text-center">Email</th>
                            <th class="min-w-200 text-center">Telpon</th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-8 mb-7">
                ...
                <form class="form" action="#">
                    ...
                    <div class="fv-row mb-10">
                        <!--begin::Label-->
                        <label class="fs-6 fw-bold form-label mb-2">Tipe User</label>
                        <!--end::Label-->
                        <div class="position-relative d-flex align-items-center">
                            <select class="form-select form-select-solid" data-control="select2" data-placeholder="Pilih tipe user">
                                <option></option>
