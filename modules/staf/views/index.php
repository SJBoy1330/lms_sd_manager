    ...
    <div class="card mb-5 mb-xl-8">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1">Staf Sekolah</span>
                ...
                <table class="table align-middle gs-0 gy-4">
                    ...
                    <thead>
                        <tr class="fw-bolder text-muted bg-light">
                            ...
                            <th class="min-w-200 text-center">Foto</th>
                            <th class="min-w-200 text-center">Nama Sekolah</th>
                            <th class="min-w-200 text-center">Nama</th>
                            <th class="min-w-200 text-center">Username</th>
                            <th class="min-w-200 text-center">Tipe</th>
                            <th class="min-w-200 text-center">Aktif</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="fw-bolder text-center">
                                <img src="<?= base_url('assets/img/vek-1.png');?>" width="50" height="50" class="rounded-circle" alt="">
                            </td>
                            <td class="fw-bolder text-center">
                                ALPHATECH SCHOOL
                            </td>
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <!--begin::Modal title-->
                <h2 class="fw-bolder">Tambah Staf Sekolah</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-8 mb-7">
                ...
                <form class="form" action="#">
                    <div class="fv-row mb-10 d-flex justify-content-center align-items-center flex-column">
                        <!--begin::Label-->
                        <label class="fs-6 fw-bold form-label mb-3">Foto</label>
                        <!--end::Label-->
                    ...
                    <div class="fv-row mb-10">
                        <!--begin::Label-->
                        <label class="fs-6 fw-bold form-label mb-2">Userame</label>
                        <!--end::Label-->
                        <div class="position-relative d-flex align-items-center">
                            <input class="form-control form-control-solid"  placeholder="Masukkan username" />
                        </div>
                    </div>
                    ...
                    <div class="fv-row mb-10">
                        <!--begin::Label-->
                        <label class="fs-6 fw-bold form-label mb-2">NIP</label>
                        <!--end::Label-->
                        <div class="position-relative d-flex align-items-center">
                            <input class="form-control form-control-solid"  placeholder="Masukkan NIP" />
                        </div>
                    </div>
                    ...
                    <div class="fv-row mb-10">
                        ...
                        <!--end::Label-->
                        <div class="position-relative d-flex align-items-center">
                            <input class="form-control form-control-solid"  placeholder="Masukkan alamat" />
                        </div>
                    </div>
                    ...
                    <div class="fv-row mb-10">
                        <!--begin::Label-->
                        <label class="fs-6 fw-bold form-label mb-2">Tipe</label>
                        <!--end::Label-->
                        <div class="position-relative d-flex align-items-center">
                            <select class="form-select form-select-solid" data-control="select2" data-placeholder="Pilih    ">
                                <option></option>
                    ...
                    <div class="fv-row mb-10">
                        <!--begin::Label-->
                        <label class="fs-6 fw-bold form-label mb-2">Kata Sandi</label>
                        <!--end::Label-->
                        <div class="position-relative d-flex align-items-center">
                            <input class="form-control form-control-solid" type="password" placeholder="Masukkan kata sandi" />
                        </div>
                    </div>
                    <!--end::Input group-->
                    <!--begin::Input group-->
                    <div class="fv-row mb-10">
                        <!--begin::Label-->
                        <label class="fs-6 fw-bold form-label mb-2">Konfirmasi Kata Sandi</label>
                        <!--end::Label-->
                        <div class="position-relative d-flex align-items-center">
                            <input class="form-control form-control-solid" type="password" placeholder="Konfirmasi kata sandi" />
                        </div>
                    </div>
                    <!--end::Input group-->
                    <!--begin::Actions-->
